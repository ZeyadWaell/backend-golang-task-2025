...
{
    /// <inheritdoc />
    public partial class FullOvertWrite : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductItemOption", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductItemOption_ProductItem_ProductItemId",
                        column: x => x.ProductItemId,
                        principalTable: "ProductItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductItemOption_VariationOption_VariationOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductItemOption_ProductItemId",
                table: "ProductItemOption",
                column: "ProductItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductItemOption_VariationOptionId",
                table: "ProductItemOption",
